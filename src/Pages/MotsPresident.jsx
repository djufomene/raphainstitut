    ...
    <div className="motspr">      
      ...
      <div className="homepage">
            <header className="header">
                ...
                <div className="title">Mot du Président Fondateur</div>
            </header>
            ...
            <div className="lettrine-wrapper">
                ...
                <p>
                    ...
                    &emsp;&emsp;Notre projet éducatif repose sur trois piliers fondamentaux : la qualité de la formation, l’employabilité des étudiants, et l’ouverture sur le monde. Nos programmes sont conçus en lien étroit avec les besoins du marché du travail et les évolutions technologiques. Grâce à une équipe pédagogique expérimentée et passionnée, nous accompagnons chaque étudiant dans la construction de son parcours personnel et professionnel.<br /><br />
